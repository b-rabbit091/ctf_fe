...
const AdminPracticeEdit: React.FC = () => {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        if (!questionSaved) {
            setError(
                "Please validate and save the question draft before updating the practice challenge."
            );
        ...
        try {
            ...
            // Future: wire these to backend endpoints
                        ...
                        {activeTab === "solution" && questionSaved && (
                            <div className="space-y-6 px-6 py-6">
                                <div
                                    ...
                                    answers. They should not be exposed to participants.
                                </div>
